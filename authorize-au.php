    ...
    <aside id="fh5co-aside" role="complementary" class="border js-fullheight">
      ...
      <nav id="fh5co-main-menu" role="navigation">
        <ul>  
          ...
          <li><a href="authorize-au.php">Audit</a></li>
      ...
      <div class="fh5co-narrow-content">
        <div class="row">
          <div class="animate-box" data-animate-effect="fadeInLeft">
            <h1 class="fh5co-heading-colored">AUTHORIZE &amp; AUDIT</h1>
          </div>
        </div>
        <div class="row">
          <div class="animate-box" data-animate-effect="fadeInLeft">
            <?php
              ...
              $result = mysql_query("SELECT * FROM audit ") or die(mysql_error());
             ?>
            ...
            <div id="users-contain" class="ui-widget" style="text-align: center;overflow-x:auto;margin:auto;width: 100%;padding: 10px;margin-top: 30px;">
              <h1 style="color:#36FE00;">Audit Online:</h1>
              <table id="users" class="ui-widget ui-widget-content" style="width:100%;overflow-x:auto;margin:auto;padding: 10px;margin-top: 10px;">
                ...
                ?>  
                  <tr class="record">
                    ...
                    <td><?php echo $row['AuditName']?></td>
                    <td><?php echo $row['AuditEmail']?></td>
